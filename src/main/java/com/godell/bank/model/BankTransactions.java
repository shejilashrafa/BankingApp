...
public class BankTransactions {
	...
	public String toString() {
		return "BankTransactions [transactionNumber=" + transactionNumber + ", accountType=" + accountType + ", amount="
				+ amount + ", currency=" + currency + ",  operation=" + operation + ", tran_sastus=" + tran_sastus
				+ ", transacctionTime=" + transacctionTime + ", account=" + account + "]";
	}

	public BankTransactions(long transactionNumber, String accountType, double amount, String currency,
